      ...
      <Card class="min-w-1/4 max-w-md"> 
        <template #content>
          ...
          <div class="w-full flex justify-center">
            <img src="@/assets/aktionSodisBig.png" alt="Company Logo" class="w-1/2" />
          </div>
...
import backgroundImage from '@/assets/colleagues.jpg';
...
const onLogin = async (submit_event: FormSubmitEvent) => {
  if(submit_event.valid) {
    ...
    const login_result = await authStore.login(entered_username, entered_password);
    console.log()
  }
};
