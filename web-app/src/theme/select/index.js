export default {
  root: ({ props, state, parent }) => ({
    class: [
      ...
      // Invalid State
      'invalid:focus:ring-danger-200',
      'invalid:hover:border-danger',
      { 'border-danger dark:border-danger': props.invalid },
      ...
      {
        'outline-none outline-offset-0 z-10': state.focused,
      },
      {
        'ring-1 ring-primary dark:ring-primary-400':
          state.focused && !props.invalid,
      },
      ...
      // Filled State *for FloatLabel
      {
        filled:
          (parent.instance?.$name == 'FloatLabel' ||
            ...
            parent?.instance?.$params?.instance?.$parentInstance?.$name) &&
          parent.props.modelValue !== undefined &&
  ...
  option: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        'text-surface-700 dark:text-surface-200': !context.selected,
