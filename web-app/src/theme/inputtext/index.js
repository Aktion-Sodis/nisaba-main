export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      'invalid:hover:text-danger-500',
      {
        'border-danger hover:border-danger dark:border-danger-400':
          props.invalid,
      },

      {
        'placeholder:!text-danger-400': props.invalid,
      },
      ...
      // States
      {
        ...
        'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 dark:focus:ring-primary-400 focus:z-10':
          !context.disabled && !props.invalid,
        'focus:outline-none focus:outline-offset-0 focus:ring-none focus:z-10':
          !context.disabled && props.invalid,
