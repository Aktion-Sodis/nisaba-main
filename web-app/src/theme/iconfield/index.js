export default {
  root: {
    class: [
      ...
      '[&>[data-pc-name=inputicon]]:text-surface-500 dark:[&>[data-pc-name=inputicon]]:text-white/60',
      ...
      '[&_div>[data-pc-name=pcinputtext]]:!rounded-md',
      '[&_div>[data-pc-name=pcinputtext]]:!pl-9',

      // filter
      '[&>[data-pc-extend=inputicon]]:absolute',
      '[&>[data-pc-extend=inputicon]]:top-1/2',
      '[&>[data-pc-extend=inputicon]]:-mt-2',
      '[&>[data-pc-extend=inputicon]]:text-surface-500 dark:[&>[data-pc-extend=inputicon]]:text-white/60',
