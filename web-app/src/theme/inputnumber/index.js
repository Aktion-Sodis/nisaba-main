export default {
      ...
      class: [
        ...
        },
        {
          '!rounded-none':
            ...
            (parent.props.buttonLayout.includes('horizontal') ||
              parent.props.buttonLayout.includes('vertical')),
        },
  ...
  incrementButton: ({ props }) => ({
    class: [
      ...
      'relative',
      {
        'order-last': props.showButtons && props.buttonLayout === 'horizontal',
      },
      { 'order-first': props.showButtons && props.buttonLayout === 'vertical' },
  ...
  decrementButton: ({ props }) => ({
    class: [
      ...
      'relative',
      {
        'order-first': props.showButtons && props.buttonLayout === 'horizontal',
      },
      { 'order-last': props.showButtons && props.buttonLayout === 'vertical' },
