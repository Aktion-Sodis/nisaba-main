    ...
    <div class="h-screen w-screen bg-cover bg-center flex items-center justify-center":style="{ backgroundImage: `url(${backgroundImage})` }">
        <Card class="min-w-1/4 max-w-md"> 
          <template #content>
            ...
            <Form v-if="authStore.nextStep === null && authStore.authenticationState !== AuthenticationState.LoggedIn" 
                  v-slot="$loginForm" 
                  @submit="onLogin" 
              ...
              <div class="flex flex-col gap-0">
                <div class="flex flex-col gap-2 mt-4">
                  ...
                  <Message v-if="$loginForm.username?.invalid" severity="error" size="small" variant="simple">
                ...
                <div class="flex flex-col gap-2 mt-4">
                  ...
                  <Message v-if="$loginForm.password?.invalid" severity="error" size="small" variant="simple">
                ...
                <!-- Submit Button -->
                <Button label="Login" icon="pi pi-sign-in" class="w-full p-button-primary mt-4" type="submit" fluid />
              </div>
            </Form>
