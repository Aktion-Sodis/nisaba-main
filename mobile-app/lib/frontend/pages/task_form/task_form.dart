                ...
                child: Row(
                  children: [
                    Expanded(
                        child: Row(
                      children: [
                        _iconButton(MdiIcons.microphoneOutline, () => null),
                        SizedBox(
                    ...
                    Expanded(
                        child: Row(
                      children: [
                        _iconButton(MdiIcons.cameraOutline, () => null),
                        SizedBox(
                          width: defaultPadding(context),
                        ),
                        const Expanded(
            ...
            Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: defaultPadding(context)),
                      child: _iconButton(
                        MdiIcons.magnify,
                        () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => TaskCategorySearch(
