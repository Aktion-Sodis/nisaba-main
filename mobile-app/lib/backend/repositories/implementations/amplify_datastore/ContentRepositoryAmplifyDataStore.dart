...
class ContentRepositoryAmplifyDataStore extends definition.ContentRepository {
  static final ContentRepositoryAmplifyDataStore instance =
      ContentRepositoryAmplifyDataStore._();
  ...
  Future<amp.Content> _populate(amp.Content content) async {
