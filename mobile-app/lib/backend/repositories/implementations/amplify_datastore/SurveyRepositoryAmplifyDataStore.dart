...
class SurveyRepositoryAmplifyDataStore extends SurveyRepository {
  static final SurveyRepositoryAmplifyDataStore instance =
      SurveyRepositoryAmplifyDataStore._();
  SurveyRepositoryAmplifyDataStore._();
  ...
  Future<List<amp.Survey>> getAllAmpSurveys() async {
  ...
  Future<amp.Survey> getAmpSurveyByID(String surveyID) async {
    List<amp.Survey> results = await Amplify.DataStore.query(
        amp.Survey.classType,
  ...
  Future<amp.Survey> _populate(amp.Survey survey,
  ...
  Future<List<amp.Survey>> _populateList(List<amp.Survey> surveys,
