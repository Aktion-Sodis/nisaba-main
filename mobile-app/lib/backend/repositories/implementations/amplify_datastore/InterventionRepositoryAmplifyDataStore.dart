...
class InterventionRepositoryAmplifyDataStore
    extends definition.InterventionRepository {
  static final InterventionRepositoryAmplifyDataStore instance =
      InterventionRepositoryAmplifyDataStore._();

  InterventionRepositoryAmplifyDataStore._();

  Future<List<amp.Intervention>> getAllAmpIntervention() async {
  ...
  Future<amp.Intervention> getAmpInterventionByID(String interventionID) async {
    try {
  ...
  Future<amp.Intervention?> getAmplifyInterventionBySurvey(
  ...
  Future<amp.Intervention> populate(amp.Intervention intervention) async {
