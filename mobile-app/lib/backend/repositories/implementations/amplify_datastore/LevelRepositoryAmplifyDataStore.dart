...
class LevelRepositoryAmplifyDataStore extends LevelRepository {
  static final LevelRepositoryAmplifyDataStore instance =
      LevelRepositoryAmplifyDataStore._();
  LevelRepositoryAmplifyDataStore._();

  Future<List<amp.Level>> getAllAmpLevels() async {
  ...
  Future<amp.Level> getAmpLevelByID(String levelID) async {
  ...
  Future<amp.Level> _populate(amp.Level level) async {
