  ...
  Intervention.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _name = json['name'] != null
          ? json['name']['serializedData'] != null
              ? I18nString.fromJson(new Map<String, dynamic>.from(json['name']['serializedData']))
              : I18nString.fromJson(new Map<String, dynamic>.from(json['name']))
        : null,
      _description = json['description'] != null
          ? json['description']['serializedData'] != null
              ? I18nString.fromJson(new Map<String, dynamic>.from(json['description']['serializedData']))
              : I18nString.fromJson(new Map<String, dynamic>.from(json['description']))
        : null,
      _interventionType = amplify_core.enumFromString<InterventionType>(json['interventionType'], InterventionType.values),
      _contents = json['contents']  is Map
        ? (json['contents']['items'] is List
          ? (json['contents']['items'] as List)
              .where((e) => e != null)
              .map((e) => InterventionContentRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['contents'] is List
          ? (json['contents'] as List)
              ...
              .toList()
          : null),
      _surveys = json['surveys']  is Map
        ? (json['surveys']['items'] is List
          ? (json['surveys']['items'] as List)
              .where((e) => e != null)
              .map((e) => Survey.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['surveys'] is List
      ...
      _tags = json['tags']  is Map
        ? (json['tags']['items'] is List
          ? (json['tags']['items'] as List)
              .where((e) => e != null)
              .map((e) => InterventionInterventionTagRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['tags'] is List
          ? (json['tags'] as List)
      ...
      _levels = json['levels']  is Map
        ? (json['levels']['items'] is List
          ? (json['levels']['items'] as List)
              .where((e) => e != null)
              .map((e) => LevelInterventionRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['levels'] is List
          ? (json['levels'] as List)
