...
class User extends amplify_core.Model {
  ...
  User copyWith({String? firstName, String? lastName, String? bio, List<Permission>? permissions, int? schemeVersion}) {
    return User._internal(
      id: id,
  ...
  User copyWithModelFieldValues({
    ...
    ModelFieldValue<List<Permission>>? permissions,
    ...
    : id = json['id'],
      ...
      _permissions = json['permissions'] is List
        ? (json['permissions'] as List)
          .where((e) => e != null)
          .map((e) => Permission.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: true,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'Permission')
    ));
