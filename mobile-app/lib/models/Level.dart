...
class Level extends Model {
  ...
  LevelModelIdentifier get modelIdentifier {
    return LevelModelIdentifier(id: id);
  }
  ...
  const Level._internal(
      {required this.id,
      required name,
      required description,
      parentLevelID,
      required interventionsAreAllowed,
      ...
      : _name = name,
        ...
        _interventionsAreAllowed = interventionsAreAllowed,
        _allowedInterventions = allowedInterventions,
  ...
  factory Level(
      ...
      required I18nString description,
      String? parentLevelID,
      required bool interventionsAreAllowed,
      List<LevelInterventionRelation>? allowedInterventions,
      required List<CustomData> customData,
      int? schemeVersion}) {
    return Level._internal(
        ...
        allowedInterventions: allowedInterventions != null
            ? List<LevelInterventionRelation>.unmodifiable(allowedInterventions)
            : allowedInterventions,
        customData: customData != null
            ? List<CustomData>.unmodifiable(customData)
            : customData,
  ...
  bool operator ==(Object other) {
    ...
    return other is Level &&
        ...
        DeepCollectionEquality()
            .equals(_allowedInterventions, other._allowedInterventions) &&
  ...
  String toString() {
    ...
    buffer.write("description=" +
        (_description != null ? _description!.toString() : "null") +
        ", ");
    buffer.write("parentLevelID=" + "$_parentLevelID" + ", ");
    buffer.write("interventionsAreAllowed=" +
        (_interventionsAreAllowed != null
            ? _interventionsAreAllowed!.toString()
            : "null") +
        ", ");
    buffer.write("customData=" +
        (_customData != null ? _customData!.toString() : "null") +
        ", ");
    buffer.write("schemeVersion=" +
        (_schemeVersion != null ? _schemeVersion!.toString() : "null") +
        ", ");
  ...
  Level copyWith(
    ...
    return Level._internal(
        ...
        interventionsAreAllowed:
            interventionsAreAllowed ?? this.interventionsAreAllowed,
  ...
  Level.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _description = json['description']?['serializedData'] != null
            ? I18nString.fromJson(new Map<String, dynamic>.from(
                json['description']['serializedData']))
            : null,
        ...
        _allowedInterventions = json['allowedInterventions'] is List
            ? (json['allowedInterventions'] as List)
                ...
                .map((e) => LevelInterventionRelation.fromJson(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'allowedInterventions': _allowedInterventions
            ?.map((LevelInterventionRelation? e) => e?.toJson())
            .toList(),
        'customData': _customData?.map((CustomData? e) => e?.toJson()).toList(),
  ...
  static final QueryModelIdentifier<LevelModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<LevelModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField DESCRIPTION = QueryField(fieldName: "description");
  static final QueryField PARENTLEVELID =
      QueryField(fieldName: "parentLevelID");
  static final QueryField INTERVENTIONSAREALLOWED =
      QueryField(fieldName: "interventionsAreAllowed");
  ...
  static final QueryField SCHEMEVERSION =
      QueryField(fieldName: "schemeVersion");
  static var schema =
...
class LevelModelIdentifier implements ModelIdentifier<Level> {
  ...
  const LevelModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is LevelModelIdentifier && id == other.id;
  }
