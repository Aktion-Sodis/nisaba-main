...
class Level extends amplify_core.Model {
  ...
  Level.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _allowedInterventions = json['allowedInterventions']  is Map
        ? (json['allowedInterventions']['items'] is List
          ? (json['allowedInterventions']['items'] as List)
              .where((e) => e != null)
              .map((e) => LevelInterventionRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['allowedInterventions'] is List
      ...
      _customData = json['customData'] is List
        ? (json['customData'] as List)
          .where((e) => e != null)
          .map((e) => CustomData.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
