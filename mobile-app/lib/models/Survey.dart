  ...
  Survey.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _description = json['description'] != null
        ...
        : null,
      _intervention = json['intervention'] != null
        ? json['intervention']['serializedData'] != null
          ? Intervention.fromJson(new Map<String, dynamic>.from(json['intervention']['serializedData']))
          : Intervention.fromJson(new Map<String, dynamic>.from(json['intervention']))
        : null,
      _questions = json['questions'] is List
        ? (json['questions'] as List)
          .where((e) => e != null)
          .map((e) => Question.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
      _tags = json['tags']  is Map
        ? (json['tags']['items'] is List
          ? (json['tags']['items'] as List)
              .where((e) => e != null)
              .map((e) => SurveySurveyTagRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['tags'] is List
          ? (json['tags'] as List)
