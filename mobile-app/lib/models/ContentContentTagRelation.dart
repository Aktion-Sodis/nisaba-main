...
class ContentContentTagRelation extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'content': _content, 'contentTag': _contentTag, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<ContentContentTagRelationModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<ContentContentTagRelationModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      ModelIndex(fields: const ["contentTagId"], name: "byContentTag")
    ];
 ...
 */
@immutable
class ContentContentTagRelationModelIdentifier implements ModelIdentifier<ContentContentTagRelation> {
  final String id;
