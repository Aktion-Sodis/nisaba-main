...
class Entity extends amplify_core.Model {
  ...
  Entity.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _level = json['level'] != null
        ? json['level']['serializedData'] != null
          ? Level.fromJson(new Map<String, dynamic>.from(json['level']['serializedData']))
          : Level.fromJson(new Map<String, dynamic>.from(json['level']))
        : null,
      ...
      _customData = json['customData'] is List
        ? (json['customData'] as List)
          .where((e) => e != null)
          .map((e) => AppliedCustomData.fromJson(new Map<String, dynamic>.from(e['serializedData'] ?? e)))
          .toList()
        : null,
      _appliedInterventions = json['appliedInterventions']  is Map
        ? (json['appliedInterventions']['items'] is List
          ? (json['appliedInterventions']['items'] as List)
              .where((e) => e != null)
              .map((e) => AppliedIntervention.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['appliedInterventions'] is List
