  ...
  InterventionInterventionTagRelation.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _intervention = json['intervention'] != null
        ...
        : null,
      _interventionTag = json['interventionTag'] != null
        ? json['interventionTag']['serializedData'] != null
          ? InterventionTag.fromJson(new Map<String, dynamic>.from(json['interventionTag']['serializedData']))
          : InterventionTag.fromJson(new Map<String, dynamic>.from(json['interventionTag']))
        : null,
