...
class SurveySurveyTagRelation extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'survey': _survey, 'surveyTag': _surveyTag, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<SurveySurveyTagRelationModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<SurveySurveyTagRelationModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["surveyId"], name: "bySurvey"),
      ModelIndex(fields: const ["surveyTagId"], name: "bySurveyTag")
    ];
 ...
 */
@immutable
class SurveySurveyTagRelationModelIdentifier implements ModelIdentifier<SurveySurveyTagRelation> {
  final String id;
