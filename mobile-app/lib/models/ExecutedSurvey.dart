...
class ExecutedSurvey extends Model {
  ...
  const ExecutedSurvey._internal(
      {required this.id,
      required appliedIntervention,
      required survey,
      required whoExecutedIt,
      required date,
      location,
      required answers,
      schemeVersion,
      createdAt,
      updatedAt,
      required executedSurveySurveyId,
      required executedSurveyWhoExecutedItId})
      : _appliedIntervention = appliedIntervention,
        _survey = survey,
        _whoExecutedIt = whoExecutedIt,
        _date = date,
        _location = location,
        _answers = answers,
        ...
        _executedSurveySurveyId = executedSurveySurveyId,
        _executedSurveyWhoExecutedItId = executedSurveyWhoExecutedItId;

  factory ExecutedSurvey(
      {String? id,
      required AppliedIntervention appliedIntervention,
      required Survey survey,
      required User whoExecutedIt,
    ...
    return ExecutedSurvey._internal(
        ...
        answers: answers != null
            ? List<QuestionAnswer>.unmodifiable(answers)
            : answers,
  ...
  String toString() {
    ...
    buffer.write("appliedIntervention=" +
        (_appliedIntervention != null
            ? _appliedIntervention!.toString()
            : "null") +
        ", ");
    ...
    buffer.write("location=" +
        ...
        ", ");
    buffer.write(
        "answers=" + (_answers != null ? _answers!.toString() : "null") + ", ");
  ...
  ExecutedSurvey copyWith(
    ...
    return ExecutedSurvey._internal(
        ...
        executedSurveySurveyId:
            executedSurveySurveyId ?? this.executedSurveySurveyId,
        executedSurveyWhoExecutedItId: executedSurveyWhoExecutedItId ??
            this.executedSurveyWhoExecutedItId);
  }

  ExecutedSurvey.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _appliedIntervention =
            json['appliedIntervention']?['serializedData'] != null
                ? AppliedIntervention.fromJson(new Map<String, dynamic>.from(
                    json['appliedIntervention']['serializedData']))
                : null,
        _survey = json['survey']?['serializedData'] != null
            ? Survey.fromJson(
                new Map<String, dynamic>.from(json['survey']['serializedData']))
            : null,
        _whoExecutedIt = json['whoExecutedIt']?['serializedData'] != null
            ? User.fromJson(new Map<String, dynamic>.from(
                json['whoExecutedIt']['serializedData']))
            : null,
        _date = json['date'] != null
            ? TemporalDateTime.fromString(json['date'])
            : null,
        _location = json['location']?['serializedData'] != null
            ? Location.fromJson(new Map<String, dynamic>.from(
  ...
  Map<String, dynamic> toJson() => {
        'id': id,
        'appliedIntervention': _appliedIntervention?.toJson(),
        'survey': _survey?.toJson(),
        'whoExecutedIt': _whoExecutedIt?.toJson(),
        'date': _date?.format(),
        'location': _location?.toJson(),
        'answers': _answers?.map((QuestionAnswer? e) => e?.toJson()).toList(),
  ...
  static final QueryField EXECUTEDSURVEYSURVEYID =
      QueryField(fieldName: "executedSurveySurveyId");
  static final QueryField EXECUTEDSURVEYWHOEXECUTEDITID =
      QueryField(fieldName: "executedSurveyWhoExecutedItId");
  static var schema =
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
        ...
        ofType: ModelFieldType(ModelFieldTypeEnum.embeddedCollection,
            ofCustomTypeName: 'QuestionAnswer')));
