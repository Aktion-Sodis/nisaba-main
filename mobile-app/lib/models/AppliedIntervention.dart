...
class AppliedIntervention extends amplify_core.Model {
  ...
  AppliedIntervention.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _whoDidIt = json['whoDidIt'] != null
        ? json['whoDidIt']['serializedData'] != null
          ? User.fromJson(new Map<String, dynamic>.from(json['whoDidIt']['serializedData']))
          : User.fromJson(new Map<String, dynamic>.from(json['whoDidIt']))
        : null,
      ...
      _location = json['location'] != null
        ...
        : null,
      _isOkay = json['isOkay'],
      _executedSurveys = json['executedSurveys']  is Map
        ? (json['executedSurveys']['items'] is List
          ? (json['executedSurveys']['items'] as List)
              .where((e) => e != null)
              .map((e) => ExecutedSurvey.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['executedSurveys'] is List
