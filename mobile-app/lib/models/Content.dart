...
class Content extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'description': _description, 'interventions': _interventions, 'tags': _tags, 'schemeVersion': _schemeVersion, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
