  ...
  Content.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _description = json['description'] != null
        ...
        : null,
      _interventions = json['interventions']  is Map
        ? (json['interventions']['items'] is List
          ? (json['interventions']['items'] as List)
              .where((e) => e != null)
              .map((e) => InterventionContentRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['interventions'] is List
      ...
      _tags = json['tags']  is Map
        ? (json['tags']['items'] is List
          ? (json['tags']['items'] as List)
              .where((e) => e != null)
              .map((e) => ContentContentTagRelation.fromJson(new Map<String, dynamic>.from(e)))
              .toList()
          : null)
        : (json['tags'] is List
          ? (json['tags'] as List)
