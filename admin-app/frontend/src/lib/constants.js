...
export const allowedFileUploadTypes = Object.freeze([
  "image/png",
  "audio/mpeg",
  "application/pdf",
]);
...
archived.set(true, {
  icon: "mdi-archive",
  tooltipI18nSelector: "general.filters.showArchived",
});
const _deleted = new Map();
_deleted.set(false, {
  icon: "mdi-delete",
  tooltipI18nSelector: "general.filters.hideDeleted",
});
_deleted.set(true, {
...
export const localeToFlagArray = Object.freeze([
  {
    locale: "en-US",
    flag: "🇺🇸",
  },
