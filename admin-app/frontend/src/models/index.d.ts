...
export declare type I18nString = LazyLoading extends LazyLoadingDisabled ? EagerI18nString : LazyI18nString
...
export declare type ColorTheme = LazyLoading extends LazyLoadingDisabled ? EagerColorTheme : LazyColorTheme
...
export declare type AppliedCustomData = LazyLoading extends LazyLoadingDisabled ? EagerAppliedCustomData : LazyAppliedCustomData

export declare const AppliedCustomData: (new (init: ModelInit<AppliedCustomData>) => AppliedCustomData)
...
export declare const Config: (new (init: ModelInit<Config>) => Config) & {
  copyOf(source: Config, mutator: (draft: MutableModel<Config>) => MutableModel<Config> | void): Config;
}
...
export declare type Intervention = LazyLoading extends LazyLoadingDisabled ? EagerIntervention : LazyIntervention

export declare const Intervention: (new (init: ModelInit<Intervention>) => Intervention) & {
  copyOf(source: Intervention, mutator: (draft: MutableModel<Intervention>) => MutableModel<Intervention> | void): Intervention;
}
...
export declare type AppliedIntervention = LazyLoading extends LazyLoadingDisabled ? EagerAppliedIntervention : LazyAppliedIntervention

export declare const AppliedIntervention: (new (init: ModelInit<AppliedIntervention>) => AppliedIntervention) & {
  copyOf(source: AppliedIntervention, mutator: (draft: MutableModel<AppliedIntervention>) => MutableModel<AppliedIntervention> | void): AppliedIntervention;
}
...
export declare type ExecutedSurvey = LazyLoading extends LazyLoadingDisabled ? EagerExecutedSurvey : LazyExecutedSurvey

export declare const ExecutedSurvey: (new (init: ModelInit<ExecutedSurvey>) => ExecutedSurvey) & {
  copyOf(source: ExecutedSurvey, mutator: (draft: MutableModel<ExecutedSurvey>) => MutableModel<ExecutedSurvey> | void): ExecutedSurvey;
}
...
export declare type SessionData = LazyLoading extends LazyLoadingDisabled ? EagerSessionData : LazySessionData
...
export declare type LevelInterventionRelation = LazyLoading extends LazyLoadingDisabled ? EagerLevelInterventionRelation : LazyLevelInterventionRelation

export declare const LevelInterventionRelation: (new (init: ModelInit<LevelInterventionRelation>) => LevelInterventionRelation) & {
  copyOf(source: LevelInterventionRelation, mutator: (draft: MutableModel<LevelInterventionRelation>) => MutableModel<LevelInterventionRelation> | void): LevelInterventionRelation;
}
...
export declare type InterventionContentRelation = LazyLoading extends LazyLoadingDisabled ? EagerInterventionContentRelation : LazyInterventionContentRelation

export declare const InterventionContentRelation: (new (init: ModelInit<InterventionContentRelation>) => InterventionContentRelation) & {
  copyOf(source: InterventionContentRelation, mutator: (draft: MutableModel<InterventionContentRelation>) => MutableModel<InterventionContentRelation> | void): InterventionContentRelation;
}
...
export declare type InterventionInterventionTagRelation = LazyLoading extends LazyLoadingDisabled ? EagerInterventionInterventionTagRelation : LazyInterventionInterventionTagRelation

export declare const InterventionInterventionTagRelation: (new (init: ModelInit<InterventionInterventionTagRelation>) => InterventionInterventionTagRelation) & {
  copyOf(source: InterventionInterventionTagRelation, mutator: (draft: MutableModel<InterventionInterventionTagRelation>) => MutableModel<InterventionInterventionTagRelation> | void): InterventionInterventionTagRelation;
}
...
export declare type ContentContentTagRelation = LazyLoading extends LazyLoadingDisabled ? EagerContentContentTagRelation : LazyContentContentTagRelation

export declare const ContentContentTagRelation: (new (init: ModelInit<ContentContentTagRelation>) => ContentContentTagRelation) & {
  copyOf(source: ContentContentTagRelation, mutator: (draft: MutableModel<ContentContentTagRelation>) => MutableModel<ContentContentTagRelation> | void): ContentContentTagRelation;
}
...
export declare type SurveySurveyTagRelation = LazyLoading extends LazyLoadingDisabled ? EagerSurveySurveyTagRelation : LazySurveySurveyTagRelation

export declare const SurveySurveyTagRelation: (new (init: ModelInit<SurveySurveyTagRelation>) => SurveySurveyTagRelation) & {
  copyOf(source: SurveySurveyTagRelation, mutator: (draft: MutableModel<SurveySurveyTagRelation>) => MutableModel<SurveySurveyTagRelation> | void): SurveySurveyTagRelation;
}