...
export default {
  ...
  computed: {
    ...
    localizedName() {
      return (
        this.interventionName.languageTexts[
          this.interventionName.languageKeys.findIndex((name) => name === this.$i18n.locale)
        ] ?? ''
      );
    },
    localizedDescription() {
      return (
        this.interventionDescription.languageTexts[
          this.interventionDescription.languageKeys.findIndex((name) => name === this.$i18n.locale)
        ] ?? ''
      );
    },
  },
