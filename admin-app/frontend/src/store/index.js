...
export default new Vuex.Store({
  ...
  getters: {
    getCreatingEntityInLevelId: ({ creatingEntityInLevelId }) =>
      creatingEntityInLevelId,
    ...
    fallbackLocaleIndex: () =>
      i18n.availableLocales.findIndex((l) => l === i18n.fallbackLocale),
    uiLocaleIndex: () =>
      i18n.availableLocales.findIndex((l) => l === i18n.locale),
    ...
    calculateUILocaleString:
      ...
      ({ languageTexts }) =>
        languageTexts[uiLocaleIndex] ||
        calculateLocalizedString({ languageTexts }),
    ...
    callDeriveFilePathWithOrganizationId:
      (state, getters, rootState, rootGetters) => (arg1, arg2) => {
        const organizationId =
          rootGetters[`${vuexModulesDict.auth}/getOrganizationId`];
